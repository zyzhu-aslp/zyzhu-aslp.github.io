...
<div style="margin-top:1.2rem; padding:1rem 1.2rem; border:1px solid var(--global-divider-color, #dee2e6); border-radius:6px; background:var(--global-bg-color, #f8f9fa);">
  ...
  <ul style="margin-bottom:0; padding-left:1.2rem; line-height:1.9;">
    <li><strong><a href="https://github.com/ASLP-lab/MeanVC2" target="_blank">MeanVC2</a></strong> — Robust Low-Latency Streaming Zero-Shot Voice Conversion</li>
...
<img src="{{ '/assets/img/pub_topic_cloud_en.png' | relative_url }}" alt="Collaborators" style="width:100%; height:auto; display:block; border-radius:6px; margin-bottom:1rem;">
